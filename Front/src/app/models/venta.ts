...
export interface LetraVenta { id?: number; ventaId?: number; numeroLetra?: number; numeroVenta?: string; clienteNombre?: string; fechaVencimiento: string; monto: number; montoPagado?: number; estado?: "PENDIENTE"|"PAGADO"|"VENCIDO"; fechaPago?: string; }
