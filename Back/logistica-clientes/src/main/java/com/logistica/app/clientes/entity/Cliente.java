...
public class Cliente {
    ...
    @NotEmpty @Size(max=100) @Column(nullable=false) private String nombre;
    ...
    @Column private LocalDate fechaRegistro = LocalDate.now();
    ...
    public TipoCliente getTipo(){return tipo;} public void setTipo(TipoCliente t){this.tipo=t;}
    public BigDecimal getLimiteCredito(){return limiteCredito;} public void setLimiteCredito(BigDecimal l){this.limiteCredito=l;}
    public boolean isActivo(){return activo;} public void setActivo(boolean a){this.activo=a;}
    public LocalDate getFechaRegistro(){return fechaRegistro;} public void setFechaRegistro(LocalDate f){this.fechaRegistro=f;}
    public BigDecimal getTotalComprasAcumuladas(){return totalComprasAcumuladas;} public void setTotalComprasAcumuladas(BigDecimal t){this.totalComprasAcumuladas=t;}
}